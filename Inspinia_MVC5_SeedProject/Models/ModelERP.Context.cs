...
namespace ERP_GMEDINA.Models
{
    ...
    public partial class ERP_ZORZALEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> UDP_Vent_tbExoneracion_Estado(Nullable<int> exo_Id, Nullable<bool> exo_ExoneracionActiva, Nullable<int> exo_UsuarioModifa, Nullable<System.DateTime> exo_FechaModifica)
        {
            var exo_IdParameter = exo_Id.HasValue ?
                new ObjectParameter("exo_Id", exo_Id) :
                new ObjectParameter("exo_Id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("UDP_Vent_tbExoneracion_Estado", exo_IdParameter, exo_ExoneracionActivaParameter, exo_UsuarioModifaParameter, exo_FechaModificaParameter);
        }
        ...
        public virtual ObjectResult<UDP_Vent_tbMovimientoCaja_Apertura_Insert_Result> UDP_Vent_tbMovimientoCaja_Apertura_Insert(Nullable<short> cja_Id, Nullable<System.DateTime> mocja_FechaApertura, Nullable<int> mocja_UsuarioApertura, Nullable<System.DateTime> mocja_FechaArqueo, Nullable<int> mocja_UsuarioArquea, Nullable<System.DateTime> mocja_FechaAceptacion, Nullable<int> mocja_UsuarioAceptacion, Nullable<int> mocja_UsuarioCrea, Nullable<System.DateTime> mocja_FechaCrea)
        {
            var cja_IdParameter = cja_Id.HasValue ?
                new ObjectParameter("cja_Id", cja_Id) :
                new ObjectParameter("cja_Id", typeof(short));
